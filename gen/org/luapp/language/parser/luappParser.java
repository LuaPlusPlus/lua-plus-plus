...
public class luappParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"','", "'in'", "'function'", "'class'", "'local'", "'extends'", "'return'", 
			"'::'", "'.'", "':'", "'nil'", "'false'", "'true'", "'...'", "'('", "')'", 
			"'['", "']'", "'{'", "'}'", "'or'", "'and'", "'<'", "'>'", "'<='", "'>='", 
			"'~='", "'=='", "'..'", "'+'", "'-'", "'*'", "'/'", "'%'", "'//'", "'&'", 
			"'|'", "'~'", "'<<'", "'>>'", "'not'", "'#'", "'^'", "'new'", "'get'", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__2) | (1L << T__3) | (1L << T__4) | (1L << T__6) | (1L << T__7) | (1L << T__9) | (1L << T__13) | (1L << T__16) | (1L << T__17) | (1L << T__18) | (1L << T__21) | (1L << T__28))) != 0) || _la==NAME) {
				{
				{
				setState(103);
				stat();
	...
	public static final String _serializedATN =
		...
		"\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\5\4\u00c3\n\4\3\4\3\4\3\4\3"+
		...
		"\u00bb\5\16\b\2\u00bb\u00bc\5Z.\2\u00bc\u00dd\3\2\2\2\u00bd\u00be\7\25"+
		"\2\2\u00be\u00bf\7\24\2\2\u00bf\u00c2\5\16\b\2\u00c0\u00c1\7\26\2\2\u00c1"+
		"\u00c3\5\20\t\2\u00c2\u00c0\3\2\2\2\u00c2\u00c3\3\2\2\2\u00c3\u00c4\3"+
		"\2\2\2\u00c4\u00c5\5Z.\2\u00c5\u00dd\3\2\2\2\u00c6\u00c7\7\25\2\2\u00c7"+
		"\u00c8\7\23\2\2\u00c8\u00c9\7E\2\2\u00c9\u00dd\5*\26\2\u00ca\u00cb\7\25"+
		"\2\2\u00cb\u00ce\5\24\13\2\u00cc\u00cd\7\4\2\2\u00cd\u00cf\5\26\f\2\u00ce"+
		"\u00cc\3\2\2\2\u00ce\u00cf\3\2\2\2\u00cf\u00dd\3\2\2\2\u00d0\u00d2\7\25"+
		"\2\2\u00d1\u00d0\3\2\2\2\u00d1\u00d2\3\2\2\2\u00d2\u00d3\3\2\2\2\u00d3"+
		"\u00d4\5\24\13\2\u00d4\u00d5\7\4\2\2\u00d5\u00d6\5L\'\2\u00d6\u00dd\3"+
		"\2\2\2\u00d7\u00d9\7\25\2\2\u00d8\u00d7\3\2\2\2\u00d8\u00d9\3\2\2\2\u00d9"+
		...
		"\u00b9\3\2\2\2\u00dc\u00bd\3\2\2\2\u00dc\u00c6\3\2\2\2\u00dc\u00ca\3\2"+
