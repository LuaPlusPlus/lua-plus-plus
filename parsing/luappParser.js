...
luappParser.NAME = 63;
luappParser.NORMALSTRING = 64;
luappParser.CHARSTRING = 65;
luappParser.LONGSTRING = 66;
luappParser.INT = 67;
luappParser.HEX = 68;
luappParser.FLOAT = 69;
luappParser.HEX_FLOAT = 70;
luappParser.COMMENT = 71;
luappParser.LINE_COMMENT = 72;
luappParser.WS = 73;
luappParser.SHEBANG = 74;
...
luappParser.RULE_classbody = 40;
luappParser.RULE_addOne = 41;
luappParser.RULE_plusEqual = 42;
luappParser.RULE_multiplyEqual = 43;
luappParser.RULE_divEqual = 44;
...
luappParser.prototype.varSuffix = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 23)) & ~0x1f) == 0 && ((1 << (_la - 23)) & ((1 << (luappParser.T__22 - 23)) | (1 << (luappParser.T__27 - 23)) | (1 << (luappParser.T__31 - 23)))) !== 0) || ((((_la - 64)) & ~0x1f) == 0 && ((1 << (_la - 64)) & ((1 << (luappParser.NORMALSTRING - 64)) | (1 << (luappParser.CHARSTRING - 64)) | (1 << (luappParser.LONGSTRING - 64)))) !== 0)) {
            this.state = 329;
            this.nameAndArgs();
            this.state = 334;
            this._errHandler.sync(this);
...
luappParser.prototype.number = function() {
    ...
    try {
        ...
        this.state = 427;
        _la = this._input.LA(1);
        if(!(((((_la - 67)) & ~0x1f) == 0 && ((1 << (_la - 67)) & ((1 << (luappParser.INT - 67)) | (1 << (luappParser.HEX - 67)) | (1 << (luappParser.FLOAT - 67)) | (1 << (luappParser.HEX_FLOAT - 67)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
luappParser.prototype.string = function() {
    ...
    try {
        ...
        this.state = 429;
        _la = this._input.LA(1);
        if(!(((((_la - 64)) & ~0x1f) == 0 && ((1 << (_la - 64)) & ((1 << (luappParser.NORMALSTRING - 64)) | (1 << (luappParser.CHARSTRING - 64)) | (1 << (luappParser.LONGSTRING - 64)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
luappParser.prototype.classbody = function() {
    ...
    this.enterRule(localctx, 80, luappParser.RULE_classbody);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 453;
...
luappParser.prototype.addOne = function() {
    ...
    this.enterRule(localctx, 82, luappParser.RULE_addOne);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 464;
...
luappParser.prototype.plusEqual = function() {
    ...
    this.enterRule(localctx, 84, luappParser.RULE_plusEqual);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 466;
...
luappParser.prototype.multiplyEqual = function() {
    ...
    this.enterRule(localctx, 86, luappParser.RULE_multiplyEqual);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 468;
...
luappParser.prototype.divEqual = function() {
    ...
    this.enterRule(localctx, 88, luappParser.RULE_divEqual);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 470;
