...
var ruleNames =  [ "chunk", "block", "stat", "retstat", "label", "funcname", 
                   ...
                   "classdef", "classfunction", "classbody", "addOne", "plusEqual", 
                   "multiplyEqual", "divEqual" ];
...
luappParser.RULE_classbody = 38;
luappParser.RULE_addOne = 39;
luappParser.RULE_plusEqual = 40;
luappParser.RULE_multiplyEqual = 41;
luappParser.RULE_divEqual = 42;
...
luappParser.prototype.classbody = function() {
    ...
    this.enterRule(localctx, 76, luappParser.RULE_classbody);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 438;
...
luappParser.prototype.addOne = function() {
    ...
    this.enterRule(localctx, 78, luappParser.RULE_addOne);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 443;
...
luappParser.prototype.plusEqual = function() {
    ...
    this.enterRule(localctx, 80, luappParser.RULE_plusEqual);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 445;
...
luappParser.prototype.multiplyEqual = function() {
    ...
    this.enterRule(localctx, 82, luappParser.RULE_multiplyEqual);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 447;
...
luappParser.prototype.divEqual = function() {
    ...
    this.enterRule(localctx, 84, luappParser.RULE_divEqual);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 449;
